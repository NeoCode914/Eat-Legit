...
import { userLoginSchema, type UserLoginSchema } from "../schemas/auth";
import { useAuth } from "../context/AuthContext";
import { Eye, EyeOff, UtensilsCrossed, ArrowRight, Mail, Lock } from "lucide-react";
        ...
        <div className="relative space-y-6">
          <div className="space-y-3">
            ...
            <p className="text-white/50 text-lg leading-relaxed">
              Your personalized food reel feed is waiting. Pick up where you left off.
            </p>
          </div>

          <div className="p-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm space-y-3">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-linear-to-br from-orange-400/20 to-rose-400/20 flex items-center justify-center text-xl">
                🍕
              </div>
              <div>
                <p className="text-white text-sm font-semibold">"Best pizza reel ever seen!"</p>
                <p className="text-white/40 text-xs">— foodlover_99</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-linear-to-br from-orange-400/20 to-rose-400/20 flex items-center justify-center text-xl">
              ...
              <div>
                <p className="text-white text-sm font-semibold">"Found my new fave sushi spot"</p>
                <p className="text-white/40 text-xs">— sushi_maniac</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-3 text-center text-sm">
            ...
            <p className="text-white/40">
              ...
              <Link to="/partner/signin" className="text-orange-400 hover:text-orange-300 font-medium transition-colors">
                Partner login
              </Link>
            </p>
          </div>
